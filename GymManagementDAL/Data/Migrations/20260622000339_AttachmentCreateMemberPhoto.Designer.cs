...
namespace GymManagementDAL.Data.Migrations
{
    ...
    [Migration("20260622000339_AttachmentCreateMemberPhoto")]
    partial class AttachmentCreateMemberPhoto
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    ...
                    b.ToTable("Members", t =>
                        {
                            t.HasCheckConstraint("CK_GymUser_Phone", "Phone LIKE '01%' AND Phone Not Like '%[^0-9]%' ");

                            t.HasCheckConstraint("Email", "Email LIKE '%@%.%'");
                        });
                });

            modelBuilder.Entity("GymManagementDAL.Entities.MemberSessionRL", b =>
                {
            ...
            modelBuilder.Entity("GymManagementDAL.Entities.Member", b =>
                {
                    b.OwnsOne("GymManagementDAL.Entities.Address.CompositeAddressProperty", "Address", b1 =>
                        {
